...
public final class AppConstants {
    ...
    public static final String VERSION_NAME = "2.7.0-alpha.1";

    private AppConstants() {
    }

    public static String userAgent() {
        return "codex-meter-android/2.7.0-alpha.1 (Android " + (Build.VERSION.RELEASE == null ? "unknown" : Build.VERSION.RELEASE) + "; " + (Build.MODEL == null ? "Android" : Build.MODEL) + ")";
    }
