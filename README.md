...
## Android — Version 2.7.0-alpha.1

Version 2.7.0-alpha.1 adapts to Free-tier monthly Codex limits when a paid plan expires, adds opt-in diagnostic log tracing/export, and declutters usage-history analytics with customizable highlights. Stable 2.7.0 remains the default update channel; opt into alpha under Settings → Updates → Update channel.
