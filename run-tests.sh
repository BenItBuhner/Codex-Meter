...
test -f "$ROOT/app/src/main/res/layout/activity_material_settings.xml"
test -f "$ROOT/app/src/main/res/layout/activity_material_widget_settings.xml"
grep -q 'AppThemeMaterial' "$ROOT/app/src/main/res/values/styles.xml"
grep -q 'material_u_mode' "$ROOT/app/src/main/res/xml/preferences_settings.xml"
grep -q 'activity_material_dashboard' "$ROOT/app/src/main/java/dev/bennett/codexmeter/Ui.java"
grep -q 'SURFACE_MATERIAL.equals(value)' "$ROOT/app/src/main/java/dev/bennett/codexmeter/AppPreferences.java"
grep -q 'putString(KEY_APP_STYLE, value).commit()' "$ROOT/app/src/main/java/dev/bennett/codexmeter/AppPreferences.java"
